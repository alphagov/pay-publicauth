...
public class DatabaseTestHelper {
    ...
    public void insertAccount(TokenHash tokenHash, TokenLink randomTokenLink, TokenType tokenType, String accountId, String description, ZonedDateTime revoked, String createdBy, ZonedDateTime lastUsed) {
        insertAccount(tokenHash, randomTokenLink, tokenType, accountId, description, revoked, createdBy, lastUsed, CARD);
    }

    public void insertAccount(TokenHash tokenHash, TokenLink randomTokenLink, TokenType tokenType, String accountId, String description, ZonedDateTime revoked, String createdBy, ZonedDateTime lastUsed, TokenPaymentType tokenPaymentType) {
        ...
        handle.insert("INSERT INTO tokens(token_hash, token_link, type, account_id, description, token_type, revoked, created_by, last_used) VALUES (?,?,?,?,?,?,(? at time zone 'utc'),?,(? at time zone 'utc'))",
                tokenHash.getValue(), randomTokenLink.getValue(), tokenType, accountId, description, tokenPaymentType,
